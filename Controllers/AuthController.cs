        ...
        try {
            ...
            var userToCreate = new User {
                ...
                Bookshelves = new List<Bookshelf> {
                    new Bookshelf { Id = ObjectId.GenerateNewId().ToString(), Name = "Currently Reading", Books = new List<BookshelfBook>(), IsMutable = false },
                    new Bookshelf { Id = ObjectId.GenerateNewId().ToString(), Name = "Want to Read", Books = new List<BookshelfBook>(), IsMutable = false },
                    new Bookshelf { Id = ObjectId.GenerateNewId().ToString(), Name = "Read", Books = new List<BookshelfBook>(), IsMutable = false },
                },
